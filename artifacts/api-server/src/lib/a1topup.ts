...
export const OPERATORS = {
  ...
  electricity: [
    ...
    { code: "LED",    name: "Lakshadweep Electricity Dept." },
  ],
  gas: [
    ...
    { code: "HPCLGC", name: "Hindustan Petroleum (HP Gas)" },
  ],
  // NOTE: LIC is NOT in A1Topup's official operator list.
  // Only ICP (ICICI Prudential) and TAI (Tata AIA) are supported.
  insurance: [
    { code: "ICP", name: "ICICI Prudential Insurance" },
    { code: "TAI", name: "Tata AIA Insurance" },
  ],
  giftcard: [
